...
public class TragicCritter extends Critter {
	...
	//changed from runstats to runstat
	public static String runStat(java.util.List<Critter> avoidingCritters) {
	...
	@Override
	public javafx.scene.paint.Color viewOutlineColor() { return Color.INDIANRED; }
